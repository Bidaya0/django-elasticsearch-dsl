    ...
    class CelerySignalProcessor(RealTimeSignalProcessor):
        ...
        def handle_save(self, sender, instance, **kwargs):
            ...
            transaction.on_commit(
                    lambda : lambda : self.registry_update_task.delay(instance.pk, app_label, model_name))
            transaction.on_commit( 
                    lambda : lambda : self.registry_update_related_task.delay(instance.pk, app_label, model_name))
